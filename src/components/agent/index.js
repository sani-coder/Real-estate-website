/**
 * The above code exports a React component called "Agent" with various sub-components for creating a
 * styled agent profile page.
 * @returns A React component called "Agent" with several nested components and their respective props.
 */
