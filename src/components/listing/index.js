/**
 * The above code exports a React component called "Listing" with various sub-components and styles for
 * displaying real estate listings.
 * @returns This is a React component called "Listing" that returns a container with various child
 * components such as Text, Top, Bottom, Title, TopItem, BottomItem, Anchor, Image, ImageContainer,
 * Price, TopItemInfo, AgentName, AgentContainer, AgentImageContainer, Button, TopItemContainer, and
 * Icon. These child components are also defined as functions that return specific HTML elements with
 * certain
 */
