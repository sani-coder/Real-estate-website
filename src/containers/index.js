/* This code is exporting various components from their respective files to be used in other parts of
the application. Each line is exporting a specific component with a unique name, using the `default
as` syntax to give it an alias. The components are being imported from their respective files using
the `from` keyword and their file paths. */
